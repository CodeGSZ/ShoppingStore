<template>
    <div id="banner-swiper">
        <div class="swiper" @tachstart="touchStart" @touchmove="touchMove" @tochend="touchEnd">
            <slot></slot>
        </div>
        <!-- 小圆点 -->
    ...
    export default {
        ...
        methods: {
         ...
         handleDoom: function () {
            ...
            // 4.让swiper元素,显示第一个(目前就显示前面添加的最后一个元素)
        ...
        touchMove: function (e) {
             ...
             let currentPosition = -this.currentX * this.totalWidth;
